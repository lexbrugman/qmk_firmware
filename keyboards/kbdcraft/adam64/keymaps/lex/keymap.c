...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_64_ansi(
        ...
        KC_LCTL, KC_LCMD,  KC_LOPT,                   KC_SPC,                             KC_RALT, MO(1),    KC_LEFT,  KC_DOWN,  KC_RGHT
    ),
    ...
    [_FN1] = LAYOUT_64_ansi(
        ...
        KC_NO,   KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   KC_NO,   RGB_SPI, RGB_SPD, KC_HOME,  KC_PGUP,            KC_MUTE,
        KC_NO,   KC_NO,    KC_NO,   KC_NO,   KC_NO,   KC_NO,   NK_TOGG, KC_NO, 	 KC_NO,   KC_INS,  KC_END,   KC_PGDN,  KC_VOLU,  KC_HOME,
